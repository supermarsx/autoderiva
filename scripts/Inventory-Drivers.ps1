...
foreach ($inf in $infFiles) {
    ...
    try {
        ...
        # Matches common patterns like PCI\VEN_..., USB\VID_..., ACPI\..., HID\..., BTH\..., HDAUDIO\...
        # This is a loose match to catch IDs anywhere in the file, which is usually sufficient for inventory
