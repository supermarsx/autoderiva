...
$outputFile = Join-Path $repoRoot "non_driver_folders.txt"

Write-Host "Scanning for non-driver folders in: $driversPath"
...
Write-Host "Found $( $relativePaths.Count ) non-driver folders (folders with files but no .inf)."
